...
exercises = 20
hidden = false
keypoints = ["This kind of test is a regression test, as we're testing assuming the code up to this point was correct.", 'This is not a unit test. Unit tests would be testing individual pieces of the Framework code-base, or specific functionality you wrote into your algorithms.']
objectives = ['Actually add a test on the output of running physics']
questions = ['How does a realistic workflow look for a physics analysis?']
teaching = 5
