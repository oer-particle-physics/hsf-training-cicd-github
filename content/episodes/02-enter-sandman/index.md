...
objectives = ['Understand exit codes', 'How to print exit codes', 'How to set exit codes in a script', 'How to ignore exit codes', 'Create a script that terminates in success/error']
